        ...
        <GuestLayout>
            ...
            <div className="w-full space-y-6">
                ...
                <form onSubmit={submit} className="space-y-4">
                    <div>
                        <InputLabel htmlFor="name" value="Full Name" className={authStyles.labelClass} />
                        <TextInput
                            id="name"
                            name="name"
                            value={data.name}
                    ...
                    <div>
                        <InputLabel htmlFor="password_confirmation" value="Confirm Password" className={authStyles.labelClass} />
                        <TextInput
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <label className="ml-2 text-sm text-emerald-600">
                            I agree to the{' '}
                            <a href="#" className={authStyles.linkClass}>Terms of Service</a>
                            {' '}and{' '}
                            <a href="#" className={authStyles.linkClass}>Privacy Policy</a>
                        </label>
                    </div>
